...
\begin{proof}
    ...
    \Longleftrightarrow 
    \begin{cases}
        x \in X \setminus F_{\circ} =: G $ - открытое$ \\
...
\end{proof}
\follow 
\quad Если $U$ - открытое и $\mathcal{U} \cap A = \varnothing$, то $\mathcal{U} \cap Cl A = \varnothing$
\ifdefined\niveldos\else
\begin{proof}
