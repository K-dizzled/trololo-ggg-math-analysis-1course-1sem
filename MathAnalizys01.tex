...
\section{Предел числовой последовательности и предел последовательности в метрическом пространтстве}
    ...
    \[4t^2\langle x, y \rangle^2 - 4t^2\langle x, x \rangle \langle y, y \rangle \leq 0 \Longrightarrow \langle x, y \rangle^2 \leq \langle x, x \rangle \langle y, y \rangle\]
    \end{proof}
    ...
    \begin{enumerate}
        ...
        $\exists K : \forall k \geq K \quad \rho(x_{n_k}, a) <
        \frac{1}{2} \varepsilon$\\
